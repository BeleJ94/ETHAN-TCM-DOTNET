...
public sealed class CorrespondenceDetailsViewModel { public CorrespondenceDetails Item { get; init; } = null!; public IReadOnlyCollection<SelectListItem> Users { get; init; } = []; }
public sealed class CorrespondenceActionViewModel { public Guid Id { get; set; } public Guid AssignedToUserId { get; set; } public DateOnly? DueDate { get; set; } public CorrespondenceStatus Target { get; set; } public string? Comment { get; set; } public CorrespondenceDocumentType DocumentType { get; set; } public IFormFile? Upload { get; set; } }
